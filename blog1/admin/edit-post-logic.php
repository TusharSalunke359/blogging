...
if(isset($_POST['submit'])) {
    ...
    //set is_featued to 0 if uncheked
    ...
    if(!$title) {
        ...
        if(in_array($extension, $allowed_files)) {
            ...
            if ($thumbnail['size'] < 4000000) { 
                ...
                $_SESSION['edit-post'] = " Couldn't update post. Thumbnail size too big . Should be less than 4mb";
            }
        } else {
    ...
    if(isset($_SESSION['edit-post'])) {  // if require delete isset
        ...
        //set thumbnail name if a new one was uploaded ,keep old thumbnail name 
